...
/*@file config.h Describes all the datastructures for the config file needed. It also handles all the I/O from the config file.
 */
 ...
 * 
 * It contains all the information about what selection program it should use and what are all the bookmarks
 */
...
public:
     ...
     *
     * It will try to find a Config file in the xdg config path. If non exist it will create a config with default values.
     */
  ...
  /**@brief Destructor for the Config. It will delete everything it has to delete.
